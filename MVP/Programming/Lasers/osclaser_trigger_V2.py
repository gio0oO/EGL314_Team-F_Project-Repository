...
receiver_ip = "192.168.254.236" # IP address of your Pi
receiver_port = 2004 # Team C: 2001, Team E: 2002, Team B: 2003, Team F: 2004
...
def control_relay(addr, *args):
    if addr == "/trigger":
        ...
        if spk == 10: # Change according to spk number (refer to S536 drawing)
            if channel == 1:
                if value == 1:
        ...
        elif spk == 11: # Change according to spk number (refer to S536 drawing)
            if channel == 1:
                if value == 1:
        ...
        elif spk == 12: # Change according to spk number (refer to S536 drawing)
            if channel == 1:
                if value == 1:
